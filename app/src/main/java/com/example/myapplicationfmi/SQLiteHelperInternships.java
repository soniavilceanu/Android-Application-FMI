...
public class SQLiteHelperInternships extends SQLiteOpenHelper {

    static String DATABASE_NAME="UserDataBase";

    public static final String TABLE_NAME="Internships"; // tabela cu dashboard-urile stocate si date din acestia
    ...
    public SQLiteHelperInternships(Context context) {
