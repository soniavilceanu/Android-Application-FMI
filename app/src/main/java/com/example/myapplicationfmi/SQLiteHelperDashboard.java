...
public class SQLiteHelperDashboard extends SQLiteOpenHelper {

    static String DATABASE_NAME="UserDataBase";

    public static final String TABLE_NAME="Dashboards"; // tabela cu dashboard-urile stocate si date din acestia
    ...
    public SQLiteHelperDashboard(Context context) {
